layui.define(['element'], function (exports) {
    ...
    function createStyle(ulClassName, width) {
        var style = '.{name} {position: absolute;width: {width_}px;z-index: 9999;display: none;background-color: #fff;padding: 5px;color: #333;border: 1px solid #eee;border-radius: 2px;cursor: pointer;}.{name} li {text-align: center;display: block;height: 30px;line-height: 32px;}.{name} li:hover {background-color: #666;color: #fff;}'
    ...
    function _CustomRightClick(rightMenuConfig) {
        ...
        $("#" + rightmenuObj.filter).on('contextmenu', 'li', function (e) {
            ...
            popupmenu.css({left: (leftValue+20), top: (topValue+15)}).show();
            return false;
        });
